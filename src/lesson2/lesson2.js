...
const Lesson2 = () => {
    return (
        <table className={"moon1"}>
            <tr>
                <td>
                    <table className={"moon2"} align={"center"} cellSpacing={15} cellPadding={15}>
                        <tr>
                            <td>
                                <h1 className={"gray"}>My day</h1>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <table className={"chap"} align={"center"}>
                        <tr>
                            <td>
                                <h1 className={"color"}>SIMPLE DAY</h1>
                                    <p className={"right"}>
                                        <a href={"https://www.youtube.com/"} target={"_blank"} id={"be"}>
                                            Dont Worry. Be Happy
                                        </a>
                                    </p>
                                <p className={"white"}>
